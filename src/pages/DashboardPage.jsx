...
export default function DashboardPage() {
  ...
  const handleCreateHackathon = async (e) => {
    ...
    try {
      ...
      await setDoc(doc(db, 'hackathons', docRef.id, 'settings', CONFIG_DOC), {
        tracks: [
  ...
  const handleEditHackathon = async (id, currentName) => {
    const newName = prompt("Enter new event designation:", currentName)
